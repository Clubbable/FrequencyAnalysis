...
public class FrequencyAnalysis {
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        HashMap storage = new HashMap<Long, String>();
        ...
        outerloop :
        {
            while(true)
            {
                ...
                String test = (String)storage.get(inputCRC);
                
                if(test != null)
                {
                    if(!input.equalsIgnoreCase(test))
                    {
                        System.out.println("\n" + input +  "       " + storage.get(inputCRC));
                        System.out.println(inputCRC);
                        break outerloop;
                    }
                }
                else
                {
                    storage.put(inputCRC, input);
                }
            }
        }
        */
